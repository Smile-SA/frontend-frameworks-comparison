...
const DynamicFooter: Component = () => {
  const [footerChildrenOpen, setFooterChildrenOpen] = createSignal<
    number | undefined
  >(undefined);

  function handleToggleFooterChildren(index: number, e: MouseEvent) {
    e.preventDefault();
    setFooterChildrenOpen(footerChildrenOpen() === index ? undefined : index);
  }
        ...
        <div class="region-footer-top">
          ...
          >
            ...
            <div class="menu menu-main menu-footer">
              ...
              >
                <li
                  class="has-child"
                  onClick={[handleToggleFooterChildren, 0]}
                >
                  <a
                ...
                <li
                  class="has-child"
                  onClick={[handleToggleFooterChildren, 1]}
                >
                  <a
                    data-drupal-link-system-path="<front>"
                    class="is-active"
                ...
                <li
                  class="has-child"
                  onClick={[handleToggleFooterChildren, 2]}
                >
                  <a
                    itemprop="url"
          ...
          <div class="footer-contact">
            <div class="contact-button">
              <a href="/fr/contact" rel="external">
                Contactez-nous
              </a>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <li>
                <a
                  href="https://open-source-guide.com"
                  target="_blank"
                  rel="external"
                >
                  {" "}
            ...
            >
              ...
              <ul class="menu nav">
                <li>
                  <a
                    href="/fr/contact"
                    data-drupal-link-system-path="contact"
                    rel="external"
                  >
                    Contact
                  </a>
