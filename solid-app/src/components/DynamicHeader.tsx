...
const DynamicHeader: Component = () => {
  let rootRef: HTMLHeadElement;
  const [searchOpen, setSearchOpen] = createSignal(false);
  const [menuOpen, setMenuOpen] = createSignal(false);
  const [menuChildrenOpen, setMenuChildrenOpen] = createSignal<
    number | undefined
  >(undefined);
  ...
  function handleToggleMenuChildren(index: number, e: MouseEvent) {
    e.preventDefault();
    setMenuChildrenOpen(menuChildrenOpen() === index ? undefined : index);
  }
      ...
      <div class="container-fluid" role="heading">
        ...
        <div class="region region-header container-fluid homepage">
          <div
            ...
            classList={{ opened: menuChildrenOpen() !== undefined }}
          >
                ...
                >
                  ...
                  >
                    <a
                      href="/fr"
                      data-drupal-link-system-path="<front>"
                      classList={{ "is-active": menuChildrenOpen() === 0 }}
                      rel="external"
                    >
                      {" "}
                    ...
                    <ul
                      ...
                      classList={{ opened: menuChildrenOpen() === 0 }}
                    >
                      <li>
                        <a
                  ...
                  >
                    <a
                      href="/fr"
                      data-drupal-link-system-path="<front>"
                      classList={{ "is-active": menuChildrenOpen() === 1 }}
                      rel="external"
                    >
                      {" "}
                    ...
                    <ul
                      class="level1 list-inline"
                      classList={{ opened: menuChildrenOpen() === 1 }}
                    >
                      <li class="has-child">
                        <a
                  ...
                  >
                    <a
                      ...
                      classList={{ "is-active": menuChildrenOpen() === 2 }}
                      rel="external"
                    >
                      {" "}
                      <span itemprop="name" class="hvr-icon-grow">
                    ...
                    <ul
                      class="level1 list-inline"
                      classList={{ opened: menuChildrenOpen() === 2 }}
                    >
                      <li>
                        <a
              ...
              <div class="menu-wrapper">
                ...
                <div class="menu menu-external-link-container contact-header">
                  ...
                  >
                    <li
                      class="has-child"
                      classList={{ opened: menuChildrenOpen() === 3 }}
