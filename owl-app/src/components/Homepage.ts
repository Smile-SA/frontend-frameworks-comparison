    ...
    <div class="content">
        ...
        >
            ...
            <div class="singleblock-text">
              ...
              <div class="field--name-field-description">
                ...
                >
                  ...
                  économiques, une source inépuisée d’innovations,
                  une liberté retrouvée... Et plein d&apos;autres
                  avantages qui se comptent par centaines !
                </div>
              </div>
            </div>
            <div class="link-single-part">
          ...
          >
            ...
            <div class="link-single-part">
              <div class="link-content">
                <a
                  href="/fr/livres-blancslivres-blancs/guide-lopen-source"
                  rel="external"
                >
                  Voir le livre blanc
                </a>
      ...
      <div class="field--item">
        <section class="block-content block-content-preview_pages">
          <div class="block-content--preview-pages__row">
                ...
                <div class="field--item">
                  ...
                  >
                    ...
                    <div
                      class="field field--name-field-description-preview-pages field--type-string-long field--label-hidden field--item"
                    >
                      Découvrez comment Smile a réussi le challenge
                      de concevoir et développer un nouveau site
                      e-commerce pour Eram…
                    </div>
                  </div>
                </div>
                <div class="field--item"></div>
              ...
              >
                ...
                <div class="content">
                  ...
                  >
                    ...
                    multidimensionnelles est complexe dans un monde
                    en 2D : soit les dimensions ou les…
                  </div>
                </div>
              </div>
            ...
            <div
              style="
                background-image: url(http://www.smile.eu/sites/default/files/styles/preview_pages_pictures/public/2023-05/Palindrome%20-%20logo%20only%20-%20hd%20%282%29.jpg?itok=g-naVpLx);
                background-size: cover;
                background-repeat: no-repeat;
              "
                  ...
                  >
                    ...
                    <div class="content">
                      <div
                        class="field field--name-field-description-preview-pages field--type-string-long field--label-hidden field--item"
                      >
                        Devinez qui est le 1er expert Français de
                        Drupal ? Smile ! Construire une expérience
                        digitale riche avec…
                      </div>
                    </div>
                  </div>
              ...
              <div class="leaflet-pane leaflet-tile-pane">
                ...
                >
                  ...
                  <div
                    ...
                    style="
                      z-index: 18;
                      transform: translate3d(196px, 179px, 0px)
                        scale(1);
                    "
                  >
                    <img
      ...
      <div class="field--item">
        <div class="block-content block-content-expertises block">
          ...
          <div
            class="js-tabs ui-tabs ui-corner-all ui-widget ui-widget-content"
          >
            <ul
              role="tablist"
            ...
            >
              ...
              >
                <div class="row">
                  <div
                    class="field__item col-xs-12 col-sm-6 col-md-3"
                  >
                    <a
                    ...
                    >
                        ...
                        >
                          <div>
                            <picture>
                              <source
                                srcset="
                                  https://www.smile.eu/sites/default/files/styles/expertise_item_mobile/public/2017-08/DIGITAL_1.png?itok=cBv5EibO 1x
                                "
                      ...
                      <div class="expertise-item--link">
                        ...
                        >
                          ...
                          écosystème digital ? Ça tombe bien ! Chez
                          Smile, nous voyons les choses en grand.
                        </div>
                      </div>
                    </a>
                  </div>
                    ...
                    >
                      ...
                      <div class="expertise-item--link">
                        <div
                          class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                        >
                          Vous avez des projets de transformation ?
                          Super, on adore ça ! Que vous soyez prêts
                          ou pas ;) Nous vous accompagnons de A à Z,
                    ...
                    >
                      ...
                      <div class="expertise-item--link">
                        <div
                          class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                        >
                          Vous souhaitez lancer des produits
                          connectés parmi les plus innovants ? Vous
                          êtes au bon endroit ! Nous imaginons,
                          prototypons et concevons les objets
                    ...
                    >
                      ...
                      <div class="expertise-item--link">
                        ...
                        >
                          ...
                          infrastructure ? À tirer parti du Cloud
                          pour gagner en agilité et faire des
                          économies ?
                        </div>
                      </div>
                    </a>
                    ...
                    >
                        ...
                        >
                          <div>
                            <picture>
                              <source
                                srcset="
                                  https://www.smile.eu/files/styles/expertise_item_mobile/public/2017-09/Jahai_2.png?itok=_xTjwFLT 1x
                                "
                                media="all and (max-width: 480px)"
                                type="image/png"
                              />
                      ...
                      <div class="expertise-item--link">
                        ...
                        >
                          ...
                          niveau Platinum (le plus haut niveau) et a
                          reçu le prix «Europe Partner of the Year»
                          !
                        </div>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div class="expertise-item--link">
                        <div
                          class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                        >
                          Smile, premier expert européen de Magento,
                          est aussi partenaire Global Elite Magento
                          - un statut accordé à seulement 5
                    ...
                    >
                      ...
                      <div class="expertise-item--link">
                        <div
                          class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                        >
                          Devinez qui est le premier partenaire
                          Platinum de Liferay en France ? Smile !
                        </div>
                      </div>
                    </a>
                  </div>
