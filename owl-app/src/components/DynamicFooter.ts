...
export class DynamicFooter extends Component {
    ...
    <div class="region-footer-top">
      ...
      >
        ...
        <div class="menu menu-main menu-footer">
          ...
          >
            <li class="has-child" t-on-click="(e) => this.handleToggleFooterChildren(e, 0)">
              <a
                class="is-active"
              >
              ...
              <ul class="level1 list-inline" t-attf-style="display: {{footerChildrenOpen.value === 0 ? 'block' : 'none'}}">
                <li>
                  <a
            ...
            <li class="has-child" t-on-click="(e) => this.handleToggleFooterChildren(e, 1)">
              <a
                class="is-active"
              >
              ...
              <ul class="level1 list-inline" t-attf-style="display: {{footerChildrenOpen.value === 1 ? 'block' : 'none'}}">
                <li>
                  <a
            ...
            <li class="has-child" t-on-click="(e) => this.handleToggleFooterChildren(e, 2)">
              ...
              <ul class="level1 list-inline" t-attf-style="display: {{footerChildrenOpen.value === 2 ? 'block' : 'none'}}">
                <li>
                  <a
  ...
  footerChildrenOpen = useState<{ value: number | undefined }>({
    value: undefined,
  });
  handleToggleFooterChildren(event: MouseEvent, index: number) {
    event.preventDefault();
    this.footerChildrenOpen.value =
      this.footerChildrenOpen.value === index ? undefined : index;
  }
}
