                    ...
                    <div class="block-content-block_header_block__paragraph new-header-homepage">
                      ...
                      <div class="link-single-part">
                        <div class="link-content">
                          <a href="/fr/nos-references" class="btn blue"> Découvrez nos projets </a>
                        </div>
                      </div>
              ...
              >
                <div class="singleblock-text">
                  ...
                  <div class="field--name-field-description">
                    ...
                    >
                      Au menu de l&apos;open source : des bénéfices économiques, une source
                      inépuisée d’innovations, une liberté retrouvée... Et plein d&apos;autres
              ...
              >
                <div class="singleblock-text white_paper block_single_part_one_third_tall">
                  ...
                  >
                    ...
                    >
                      Vous avez besoin d&apos;y voir plus clair dans l&apos;éventail de solutions
                      open source du marché ? Notre livre blanc qui…
                    </div>
                  </div>
                    ...
                    <div class="field--item">
                      ...
                      >
                        ...
                        <div
                          class="field field--name-field-description-preview-pages field--type-string-long field--label-hidden field--item"
                        >
                          Découvrez comment Smile a réussi le challenge de concevoir et développer
                          un nouveau site e-commerce pour Eram…
                        </div>
                      </div>
                    </div>
                    <div class="field--item"></div>
                  ...
                  >
                    ...
                    <div class="content">
                      <div
                        class="field field--name-field-description-preview-pages field--type-string-long field--label-hidden field--item"
                      >
                        Le suivi d&apos;informations multidimensionnelles est complexe dans un monde
                      ...
                      >
                        ...
                        <div class="content">
                          <div
                            class="field field--name-field-description-preview-pages field--type-string-long field--label-hidden field--item"
                          >
                            Devinez qui est le 1er expert Français de Drupal ? Smile ! Construire
                            une expérience digitale riche avec…
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  <div class="leaflet-pane leaflet-tile-pane">
                    <div class="leaflet-layer" :style="{ zIndex: 1, opacity: 1 }">
                      ...
                      <div
                        ...
                        :style="{
                          zIndex: 18,
                          transform: 'translate3d(196px, 179px, 0px) scale(1)'
                        }"
                      >
                        <img
                          alt=""
                  ...
                  <div
                    ...
                    :style="{
                      transform: 'translate3d(4301.5px, 2974.5px, 0px) scale(16)'
                    }"
                  ></div>
                </div>
              </div>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Vous avez de grandes ambitions pour votre écosystème digital ? Ça
                              tombe bien ! Chez Smile, nous voyons les choses en grand.
                            </div>
                          </div>
                        </a>
                      </div>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Vous avez des projets de transformation ? Super, on adore ça ! Que
                              vous soyez prêts ou pas ;) Nous vous accompagnons de A à Z, de la
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Vous souhaitez lancer des produits connectés parmi les plus innovants
                              ? Vous êtes au bon endroit ! Nous imaginons, prototypons et concevons
                              les objets d’aujourd’hui et de demain.
                            </div>
                          </div>
                        </a>
                      </div>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Vous cherchez à industrialiser votre infrastructure ? À tirer parti du
                              Cloud pour gagner en agilité et faire des économies ?
                            </div>
                          </div>
                        </a>
                      </div>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Smile est aujourd’hui partenaire de Jahia, niveau Platinum (le plus
                              haut niveau) et a reçu le prix «Europe Partner of the Year» !
                            </div>
                          </div>
                        </a>
                      </div>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Smile, premier expert européen de Magento, est aussi partenaire Global
                              Elite Magento - un statut accordé à seulement 5 entreprises dans le
                              monde !
                            </div>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div class="expertise-item--link">
                            <div
                              class="field field--name-field-description field--type-string-long field--label-hidden field--item"
                            >
                              Devinez qui est le premier partenaire Platinum de Liferay en France ?
                              Smile !
                            </div>
                          </div>
                        </a>
