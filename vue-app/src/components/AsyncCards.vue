...
export type ICard = IReference | INews | IImage | ITechnology | IEvent | IWhitePaper

const cards = ref<ICard[]>([])
onMounted(() => {
  fetch('http://localhost:3333/cards')
    .then((r) => r.json())
    .then((json) => (cards.value = json))
})
...
<template>
  <div class="field--item">
    <section class="block-content block-content-preview_pages">
      <div v-for="group of groupedCards" class="block-content--preview-pages__row">
