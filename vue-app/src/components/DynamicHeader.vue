...
const rootRef = ref<HTMLHeadElement>()
const searchOpen = ref(false)
const menuOpen = ref(false)
const menuChildrenOpen = ref<number | undefined>(undefined)
const height = ref(0)
...
function handleToggleMenuChildren(index: number) {
  menuChildrenOpen.value = menuChildrenOpen.value === index ? undefined : index
}
</script>
<template>
  <header class="container-fluid" role="banner" ref="rootRef">
    <div class="container-fluid" role="heading">
      <div class="region region-header-top container-fluid homepage">
        <div class="row block-header-top sticky-hp" :class="{ 'opened-menu': menuOpen }">
          <div class="col-xs-4 col-sm-3 col-lg-2 block-header-top__menu">
            <a
              class="block-header-top__menu-btn"
              :class="{ 'menu-close': menuOpen }"
          ...
          <div class="col-xs-1 col-sm-1 block-header-top_contact">
            <div class="menu menu-external-link-container contact-header">
              ...
              >
                <li class="has-child">
                  <a href="https://blog.smile.eu/fr" item-prop="url" target="_blank">
                    <span item-prop="name" class="hvr-icon-grow"> Blog </span>
                  </a>

                  <ul class="level1 list-inline">
                    <li>
                      <a href="https://blog.smile.eu/fr" item-prop="url" target="_blank">
                        <span item-prop="name" class="hvr-icon-grow"> Smile business blog </span>
                      </a>
                    </li>
                    <li>
                      <a href="https://tech.smile.eu" item-prop="url" target="_blank">
                        <span item-prop="name" class="hvr-icon-grow"> Technical blog </span>
                      </a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="http://jobs.smile.eu" target="_blank">
                    <span class="hvr-icon-grow btn btn-orange"> Nous rejoindre </span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <span item-prop="name" class="hvr-icon-grow btn btn-bleu"> Contact </span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="col-xs-3 col-sm-2 col-lg-1 block-header-top__language">
            <div class="block-switcher-language">
              <div data-drupal-link-system-path="<front>" class="en">
                <a href="/en" class="language-link" data-drupal-link-system-path="<front>"> en </a>
              </div>
              <div data-drupal-link-system-path="<front>" class="fr is-active">
                <a
                  href="/fr"
              ...
              <div data-drupal-link-system-path="<front>" class="nl">
                <a href="/en/benelux" class="language-link" data-drupal-link-system-path="<front>">
                  nl
                </a>
              </div>
            </div>
        ...
        <div class="menu menu-external-link-container contact-header">
          <ul item-type="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
            <li class="has-child">
              <a href="https://blog.smile.eu/fr" item-prop="url" target="_blank">
                <span item-prop="name" class="hvr-icon-grow"> Blog </span>
              </a>
        ...
        >
          ...
          >
            <div
              class="form-item js-form-item form-type-search js-form-type-search form-item-search-api-fulltext js-form-item-search-api-fulltext form-no-label form-group"
            >
              <label for="edit-search-api-fulltext" class="control-label sr-only">
      ...
      <div class="region region-header container-fluid homepage">
        <div
          ...
          :class="{ opened: menuChildrenOpen !== undefined }"
        >
          <div class="menu-part-left">
            <div class="menu menu-main menu-footer">
              <ul
                ...
                class="level0 list-inline"
              >
                <li class="has-child" @click.prevent="handleToggleMenuChildren(0)">
                  <a
                    href="/fr"
                    data-drupal-link-system-path="<front>"
                    class="is-active"
                    :class="{ opened: menuChildrenOpen === 0 }"
                  >
                    <span class="hvr-icon-grow">Groupe</span>
                  </a>

                  <ul class="level1 list-inline" :class="{ opened: menuChildrenOpen === 0 }">
                    <li>
                      <a href="/fr/groupe/qui-sommes-nous" data-drupal-link-system-path="node/174">
                    ...
                    <li>
                      <a href="/fr/groupe/nos-valeurs" data-drupal-link-system-path="node/137">
                        <span class="hvr-icon-grow">Nos valeurs</span>
                      </a>
                    </li>
                    <li>
                      <a href="/fr/groupe/implantations" data-drupal-link-system-path="node/88">
                        <span class="hvr-icon-grow">Nos implantations</span>
                      </a>
                    </li>
                    <li>
                      <a href="/fr/groupe/actualites" data-drupal-link-system-path="node/89">
                    ...
                    <li>
                      ...
                      >
                        <span item-prop="name" class="hvr-icon-grow"> Evènements </span>
                      </a>
                    </li>
                    <li>
                      <a href="/fr/groupe/media" data-drupal-link-system-path="node/124">
                        <span class="hvr-icon-grow">Médias</span>
                      </a>
                    </li>
                  </ul>
                </li>
                <li class="has-child" @click.prevent="handleToggleMenuChildren(1)">
                  <a
                    href="/fr"
                    data-drupal-link-system-path="<front>"
                    class="is-active"
                  ...
                  <ul class="level1 list-inline" :class="{ opened: menuChildrenOpen === 1 }">
                    <li class="has-child">
                      <a
                      ...
                      >
                        <span item-prop="name" class="hvr-icon-grow"> Digital </span>
                      </a>
                    ...
                    <li>
                      <a href="/fr/offres/business-apps" data-drupal-link-system-path="node/169">
                        <span class="hvr-icon-grow">Business Apps</span>
                      </a>
                    </li>
                    <li>
                      <a href="/fr/offres/embarque-iot" data-drupal-link-system-path="node/168">
                        <span class="hvr-icon-grow">Embedded &amp; IoT</span>
                      </a>
                    </li>
                    <li>
                      <a href="/fr/offres/infrastructure" data-drupal-link-system-path="node/171">
                ...
                <li>
                  <a href="/fr/nos-references" data-drupal-link-system-path="node/28">
                    <span class="hvr-icon-grow">Références</span>
                  </a>
                </li>
                <li>
                  <a href="/fr/technologies" data-drupal-link-system-path="list-technologies">
                ...
                <li>
                  ...
                  >
                    <span item-prop="name" class="hvr-icon-grow"> Livres blancs </span>
                  </a>
                </li>
                <li class="has-child" @click.prevent="handleToggleMenuChildren(2)">
                  <a
                    href="/fr/innovation"
                    item-prop="url"
                  ...
                  >
                    <span item-prop="name" class="hvr-icon-grow"> Innovation </span>
                  </a>

                  <ul class="level1 list-inline" :class="{ opened: menuChildrenOpen === 2 }">
                    <li>
                      <a
                ...
                <li>
                  <a href="/fr/conseil" item-prop="url" data-drupal-link-system-path="node/1918">
                    <span item-prop="name" class="hvr-icon-grow"> Conseil </span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="menu-part-right">
            ...
            <div class="block-switcher-language">
              ...
              <div data-drupal-link-system-path="<front>" class="fr is-active">
                <a href="/fr" class="language-link is-active" ata-drupal-link-system-path="<front>">
                  fr
                </a>
              </div>
            ...
            <div class="menu-wrapper">
              <div class="menu menu-main menu-footer">
                ...
                >
                  <li
                    class="has-child"
                    :class="{ opened: menuChildrenOpen === 0 }"
                    @click.prevent="handleToggleMenuChildren(0)"
                  >
              ...
              <div class="menu menu-external-link-container contact-header">
                ...
                >
                  <li
                    class="has-child"
                    :class="{ opened: menuChildrenOpen === 3 }"
                    @click.prevent="handleToggleMenuChildren(3)"
                  >
                    <a href="https://blog.smile.eu/fr" item-prop="url" target="_blank">
                      <span item-prop="name" class="hvr-icon-grow"> Blog </span>
                    </a>
