...
const footerChildrenOpen = ref<number | undefined>(undefined);

function handleToggleFooterChildren(index: number) {
  footerChildrenOpen.value =
    footerChildrenOpen.value === index ? undefined : index;
}
</script>
<template>
      ...
      <div class="region-footer-top">
        ...
        >
          ...
          >
            ...
            <li>
              <a href="http://formations.opensourceschool.fr/" target="_blank">
