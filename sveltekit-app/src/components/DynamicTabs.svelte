		...
		<div class="js-tabs ui-tabs ui-corner-all ui-widget ui-widget-content">
			...
			>
				<li
					...
					class:ui-tabs-active={solutionsTabIndex === 0}
					class:ui-state-active={solutionsTabIndex === 0}
					aria-selected={solutionsTabIndex === 0 ? 'true' : 'false'}
					aria-expanded={solutionsTabIndex === 0 ? 'true' : 'false'}
					on:click|preventDefault={() => handleSolutionsTabIndex(0)}
				>
					<h3>
						<a
				...
				<li
					...
					class:ui-tabs-active={solutionsTabIndex === 1}
					class:ui-state-active={solutionsTabIndex === 1}
					aria-selected={solutionsTabIndex === 1 ? 'true' : 'false'}
					aria-expanded={solutionsTabIndex === 1 ? 'true' : 'false'}
					on:click|preventDefault={() => handleSolutionsTabIndex(1)}
				>
					<h3>
						<a
			...
			<div
				...
				style:display={solutionsTabIndex === 0 ? 'block' : 'none'}
			>
			...
			<div
				...
				style:display={solutionsTabIndex === 1 ? 'block' : 'none'}
			>
				<div class="paragraph paragraph--type--expertise paragraph--view-mode--default">
					<div class="row">
						<div class="field__item col-xs-12 col-sm-6 col-md-3">
								...
								<div class="expertise-item--header">
									...
									>
										<div>
											<picture>
												<source
													srcset="https://www.smile.eu/files/styles/expertise_item_mobile/public/2017-09/Drupal%20Copy.png?itok=ODF4d7qI 1x"
													media="all and (max-width: 480px)"
													type="image/png"
												/>
												<img
							...
							>
								<div class="expertise-item--header">
									...
									>
										<div>
											<picture>
												<source
													srcset="https://www.smile.eu/sites/default/files/styles/expertise_item_mobile/public/2017-09/Jahai_2.png?itok=_xTjwFLT 1x"
													media="all and (max-width: 480px)"
													type="image/png"
												/>
												<img
								...
								<div class="expertise-item--link">
									<div
										class="field field--name-field-description field--type-string-long field--label-hidden field--item"
									>
										Smile est aujourd’hui partenaire de Jahia, niveau Platinum (le plus haut niveau)
										et a reçu le prix «Europe Partner of the Year» !
									</div>
								</div>
							</a>
						</div>
