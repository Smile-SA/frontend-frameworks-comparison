<script lang="ts">
	let footerChildrenOpen: number | undefined = undefined;

	function handleToggleFooterChildren(index: number) {
		footerChildrenOpen = footerChildrenOpen === index ? undefined : index;
	}
</script>
	...
	<div class="region-footer-top">
		<div class="region-footer-top">
			<div id="block-socialmedialinks" class="block-social-media-links">
				...
				<span itemtype="http://schema.org/Organization" class="platforms inline horizontal">
					...
					<a itemprop="sameAs" href="https://github.com/Smile-SA" target="_blank" rel="external">
					...
					<a
						...
						rel="external"
					>
						<span class="fab fa-slideshare fa-2x" />
					</a>
					...
					<a
						...
						rel="external"
					>
						<span class="fab fa-youtube fa-2x" />
					</a>
				</span>
			...
			<nav role="navigation" aria-labelledby="block-mainnavigation-menu" id="block-mainnavigation">
				...
				<div class="menu menu-main menu-footer">
					<ul itemtype="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
						<li class="has-child" on:click|preventDefault={() => handleToggleFooterChildren(0)}>
							<a data-drupal-link-system-path="<front>" class="is-active" rel="external">
								{' '}
							...
							<ul
								...
								style:display={footerChildrenOpen === 0 ? 'block' : 'none'}
							>
								<li>
									<a
								...
								<li>
									<a href="/fr/groupe/media" data-drupal-link-system-path="node/124" rel="external">
										{' '}
						...
						<li class="has-child" on:click|preventDefault={() => handleToggleFooterChildren(1)}>
							<a data-drupal-link-system-path="<front>" class="is-active" rel="external">
								{' '}
							...
							<ul
								class="level1 list-inline"
								style:display={footerChildrenOpen === 1 ? 'block' : 'none'}
							>
								<li>
									<a
						...
						<li class="has-child" on:click|preventDefault={() => handleToggleFooterChildren(2)}>
							<a itemprop="url" data-drupal-link-system-path="node/157" rel="external">
								{' '}
							...
							<ul
								class="level1 list-inline"
								style:display={footerChildrenOpen === 2 ? 'block' : 'none'}
							>
								<li>
									<a
			...
			<div class="footer-contact">
				<div class="contact-button">
					<a href="/fr/contact" rel="external">Contactez-nous</a>
				</div>
			</div>
			...
			>
				...
				<ul itemtype="http://www.schema.org/SiteNavigationElement" class="menu nav">
					<li>
					...
					<li>
						<a href="http://formations.opensourceschool.fr/" target="_blank" rel="external">
							{' '}
					...
					<li>
						<a href="https://open-source-guide.com" target="_blank" rel="external">
							{' '}
		...
		<div class="region-footer">
			<div class="footer-content">
				...
				<section class="block-content block-content-basic">
					...
					>
						<p>
							Any time we start something new it is exciting and we are very motivated and
							committed.
						</p>
					</div>
				</section>
			...
			<div class="footer-menu-footer">
				...
				>
					<h2 class="visually-hidden" id="block-smileeu-footer-menu">Footer menu</h2>

					<ul class="menu nav">
						<li>
							<a href="/fr/contact" data-drupal-link-system-path="contact" rel="external">
								Contact
							</a>
						</li>
						<li>
							<a href="/fr/mentions-legales" data-drupal-link-system-path="node/69" rel="external">
								Mentions légales
							</a>
						</li>
						<li>
