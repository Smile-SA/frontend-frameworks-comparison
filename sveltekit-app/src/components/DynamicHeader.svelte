<script lang="ts">
	...
	let rootRef: HTMLHeadElement | null = null;
	let searchOpen = false;
	let menuOpen = false;
	let menuChildrenOpen: number | undefined = undefined;
	let height = 0;
	...
	function handleToggleMenuChildren(index: number) {
		menuChildrenOpen = menuChildrenOpen === index ? undefined : index;
	}
</script>

<header class="container-fluid" role="banner" bind:this={rootRef}>
	<div class="container-fluid" role="heading">
		<div class="region region-header-top container-fluid homepage">
			<div class="row block-header-top sticky-hp" class:opened-menu={menuOpen}>
				<div class="col-xs-4 col-sm-3 col-lg-2 block-header-top__menu">
					<a
						...
						on:click|preventDefault={handleToggleMenu}
					>
						<img
				...
				<div class="col-xs-1 col-sm-1 block-header-top_contact">
					<div class="menu menu-external-link-container contact-header">
						<ul itemtype="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
							<li class="has-child">
								<a href="https://blog.smile.eu/fr" itemprop="url" target="_blank" rel="external">
									{' '}
									<span itemprop="name" class="hvr-icon-grow"> Blog</span>
								</a>
								...
								<ul class="level1 list-inline">
									<li>
										...
										>
											{' '}
											<span itemprop="name" class="hvr-icon-grow"> Smile business blog </span>
										</a>
									</li>
									<li>
										<a href="https://tech.smile.eu" itemprop="url" target="_blank" rel="external">
											{' '}
											<span itemprop="name" class="hvr-icon-grow"> Technical blog </span>
										</a>
									</li>
								</ul>
							</li>
							<li>
								<a href="http://jobs.smile.eu" target="_blank" rel="external">
									{' '}
							...
							<li>
								...
								>
									{' '}
									<span itemprop="name" class="hvr-icon-grow btn btn-bleu"> Contact </span>
								</a>
							</li>
						</ul>
					</div>
				...
				<div class="col-xs-1 col-sm-1 col-lg-1 block-header-top__search">
					<a
						...
						href=""
						on:click|preventDefault={handleToggleSearch}
					>
						<img
			...
			>
				...
				<a class="close-search-bar-btn" href="" on:click|preventDefault={handleToggleSearch}>
					<img
			...
			>
				<div class="menu-part-left">
					<div class="menu menu-main menu-footer">
						<ul itemtype="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
							<li class="has-child" on:click|preventDefault={() => handleToggleMenuChildren(0)}>
								<a
									href="/fr"
									data-drupal-link-system-path="<front>"
									class="is-active"
								...
								<ul class="level1 list-inline" class:opened={menuChildrenOpen === 0}>
									...
									<li>
										...
										>
											{' '}
											<span itemprop="name" class="hvr-icon-grow"> Evènements </span>
										</a>
									</li>
									<li>
										<a
							...
							<li class="has-child" on:click|preventDefault={() => handleToggleMenuChildren(1)}>
								<a
									href="/fr"
									data-drupal-link-system-path="<front>"
									class="is-active"
								...
								<ul class="level1 list-inline" class:opened={menuChildrenOpen === 1}>
									<li class="has-child">
										...
										>
											{' '}
											<span itemprop="name" class="hvr-icon-grow"> Digital </span>
										</a>
							...
							<li>
								<a href="/fr/nos-references" data-drupal-link-system-path="node/28" rel="external">
									{' '}
							...
							<li>
								...
								>
									{' '}
									<span itemprop="name" class="hvr-icon-grow"> Livres blancs </span>
								</a>
							</li>
							<li class="has-child" on:click|preventDefault={() => handleToggleMenuChildren(2)}>
								<a
									href="/fr/innovation"
									itemprop="url"
								...
								>
									{' '}
									<span itemprop="name" class="hvr-icon-grow"> Innovation</span>
								</a>
							...
							<li>
								...
								>
									{' '}
									<span itemprop="name" class="hvr-icon-grow"> Conseil</span>
								</a>
							</li>
						</ul>
					</div>
					...
					<div class="menu-wrapper">
						<div class="menu menu-main menu-footer">
							<ul itemtype="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
								<li
									class="has-child"
									on:click|preventDefault={() => handleToggleMenuChildren(0)}
									class:opened={menuChildrenOpen === 0}
								>
									<a
										href="/fr"
									...
									<ul
										...
										style:display={menuChildrenOpen === 0 ? 'block' : 'none'}
									>
										<li>
											<a
												href="/fr/groupe/qui-sommes-nous"
								...
								<li
									class="has-child"
									on:click|preventDefault={() => handleToggleMenuChildren(1)}
									class:opened={menuChildrenOpen === 1}
								>
									<a
										href="/fr"
									...
									<ul
										class="level1 list-inline"
										style:display={menuChildrenOpen === 1 ? 'block' : 'none'}
									>
										<li class="has-child">
											<a
												href="/fr/offres/digital"
								...
								<li
									class="has-child"
									on:click|preventDefault={() => handleToggleMenuChildren(2)}
									class:opened={menuChildrenOpen === 2}
								>
									<a
										href="/fr/innovation"
									...
									<ul
										class="level1 list-inline"
										style:display={menuChildrenOpen === 2 ? 'block' : 'none'}
									>
										<li>
											<a
												href="https://www.smile.eu/fr/innovation/recherche-developpement"
						...
						<div class="menu menu-external-link-container contact-header">
							<ul itemtype="http://www.schema.org/SiteNavigationElement" class="level0 list-inline">
								<li
									class="has-child"
									on:click|preventDefault={() => handleToggleMenuChildren(3)}
								...
								>
									...
									<ul
										class="level1 list-inline"
										style:display={menuChildrenOpen === 3 ? 'block' : 'none'}
									>
										<li>
											<a
												href="https://blog.smile.eu/fr"
