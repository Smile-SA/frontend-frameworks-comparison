...
export default component$(() => {
  const footerChildrenOpen = useSignal<number | undefined>(undefined);

  const handleToggleFooterChildren = $((index: number) => {
              ...
              >
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      display:
                        footerChildrenOpen.value === 0 ? "block" : "none",
                    }}
                  >
                    <li>
                      <a
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      display:
                        footerChildrenOpen.value === 1 ? "block" : "none",
                    }}
                  >
                    <li>
                      <a
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      display:
                        footerChildrenOpen.value === 2 ? "block" : "none",
                    }}
                  >
                    <li>
                      <a
